...
from app.models import RiskScoreResponse, ExplanationResponse, FederatedTrainingUpdate
...
class MLModelService:
    ...
    def predict_risk(
        ...
        try:
            ...
            alert = fraud_probability >= settings.fraud_threshold
    ...
    def _rule_based_scoring(
        ...
        return RiskScoreResponse(
            ...
            alert=risk_score >= settings.fraud_threshold,
    ...
    async def update_model_federated(
        ...
        return {
            ...
            "participants": update.client_count,
